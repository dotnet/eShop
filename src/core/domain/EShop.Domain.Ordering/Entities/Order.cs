...
#pragma warning restore CS0414
        ...
        public Order(string userId, string userName, AddressValueObject address, int cardTypeId, string cardNumber, string cardSecurityNumber,
        ...
        //public void AddOrderStartedDomainEvent(string userId, string userName, int cardTypeId, string cardNumber,
