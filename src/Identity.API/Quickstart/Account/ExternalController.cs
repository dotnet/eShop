...
public class ExternalController : Controller
{
    ...
    private async Task<(ApplicationUser? user, string provider, string providerUserId, List<Claim> claims)> FindUserFromExternalProviderAsync(AuthenticateResult result)
    {
