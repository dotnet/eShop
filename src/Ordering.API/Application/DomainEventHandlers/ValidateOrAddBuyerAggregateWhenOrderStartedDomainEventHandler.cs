                    ...
                    : INotificationHandler<OrderStartedDomainEvent>
{
    ...
    public async Task Handle(OrderStartedDomainEvent domainEvent, CancellationToken cancellationToken)
    {
        ...
        var integrationEvent = new OrderStatusChangedToSubmittedIntegrationEvent(domainEvent.Order.Id, domainEvent.Order.OrderStatus.ToString(), buyer.Name, buyer.IdentityGuid);
