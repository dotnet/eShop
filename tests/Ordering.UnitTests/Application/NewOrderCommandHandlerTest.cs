using Inked.Ordering.API.Application.IntegrationEvents;
...
public class NewOrderRequestHandlerTest
{
    ...
    public async Task Handle_return_false_if_order_is_not_persisted()
    {
        ...
        _orderRepositoryMock.UnitOfWork.SaveChangesAsync()
        ...
        //Act
        var handler = new CreateOrderCommandHandler(_mediator, _orderingIntegrationEventService, _orderRepositoryMock,
            _identityServiceMock, LoggerMock);
    ...
    {
        return new Order("1", "fakeName", new Address("street", "city", "state", "country", "zipcode"), 1, "12", "111",
            "fakeName", DateTime.UtcNow.AddYears(1));
    }
