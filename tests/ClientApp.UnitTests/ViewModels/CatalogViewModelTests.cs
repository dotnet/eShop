...
using eShop.ClientApp.UnitTests;
...
public class CatalogItemViewModelTests
{
    ...
    {
        var CatalogItemViewModel = new CatalogViewModel(_appEnvironmentService, _navigationService);
    ...
    public async Task AddCatalogItemCommandSendsAddProductMessageTest()
    {
        ...
        catalogItemViewModel.SelectedProduct = new CatalogItem {Id = 123, Name = "test", Price = 1.23m,};
